...
const PROJECTS: Project[] = [
  {
    ...
    tech: ['Python', 'RAG', 'OpenAI API', 'React'],
    github: 'https://github.com/RoniDomi/Sustainable-Labs-ChatBot',
  },
  {
    cmd: 'mage-platform',
    description:
    ...
    github: 'https://github.com/RoniDomi/MAGE-Homepage',
  },
  {
    ...
    github: 'https://github.com/RoniDomi',
  },
  {
    cmd: 'ai-agent',
    description:
    ...
    github: 'https://github.com/RoniDomi/Ai-agent',
  },
  {
    ...
    github: 'https://github.com/RoniDomi/Huffman-Compression',
  },
  {
    cmd: 'miller-rabin-c',
    description:
    ...
    github: 'https://github.com/RoniDomi/Miller-Rabin-C',
  },
  {
    cmd: 'portfolio',
    description:
